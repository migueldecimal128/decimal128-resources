...
#elif defined(DECNUMBER_FIXED) // DECNUMBER_ARBITRARY
...
/*
  ...
  $Name:  $ - The tag name
  $Log: operator.h,v $
  Revision 1.13  2009-04-19 21:28:44  mjanders
  Updated decnumber and Intel libraries

  Revision 1.12  2009-04-14 19:34:05  mjanders
  O3

  Revision 1.11  2009-03-16 01:13:09  mjanders
  Added 128-bit modes

  Revision 1.10  2009-01-03 00:32:45  mjanders
  Moved around includes

  Revision 1.9  2009/01/03 00:21:34  mjanders
  Added native_gcc_bid round modes

  Revision 1.8  2008/11/19 06:18:57  mjanders
  Added support for NATIVE_GCC_BID and moved CONTEXT_DEFAULT

  Revision 1.7  2008/09/24 07:33:09  mjanders
  Added native gcc types

  Revision 1.6  2008/07/23 05:02:57  mjanders
  Fixed bug in round mode API.

  Revision 1.5  2008/07/23 04:53:28  mjanders
  Added round mode API.

  Revision 1.4  2008/05/19 20:01:12  mjanders
