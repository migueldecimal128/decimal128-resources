...
//{
//  char printStr[255];
//  __bid64_to_string(printStr, &(line.amt))
// operator.h
...
/*
  ...
  $Date: 2009-04-19 22:05:56 $ - The date of the last commit.
  $Name:  $ - The tag name
  $Log: operator.h,v $
  Revision 1.10  2009-04-19 22:05:56  mjanders
  Updated decnumber and Intel libraries

  Revision 1.9  2009-03-22 22:36:05  mjanders
  Added 128 bit mode and fixed divide-by-zero problem in NC

  Revision 1.8  2009-01-03 01:36:59  mjanders
  Added rounding for native_gcc_bid

  Revision 1.7  2008/11/19 06:05:41  mjanders
  Moved SET_ROUNDMODE to operator.h

  Revision 1.6  2008/07/23 05:01:41  mjanders
  Fixed bug with round mode API

  Revision 1.5  2008/07/23 04:39:52  mjanders
  Created API for round modes.

  Revision 1.4  2008/06/25 06:56:27  mjanders
  *** empty log message ***

  Revision 1.3  2008/06/16 07:40:42  mjanders
