...
// Id: $Id: hashtab.c,v 1.5 2009-04-09 19:48:21 stsen Exp $
// Date: $Date: 2009-04-09 19:48:21 $
// Author: $Author: stsen $
// =============================================================================
...
//      ;
//    if (h != t->ipos)
//      myprintf("error:ipos not in apos, apos is %ld\n", t->apos);
//  }
//
...
//      ++counter;
//  if (counter != t->count)
//    myprintf("error: counter %ld  t->count %ld\n", counter, t->count);
//}
...
{
  ub4 i,len;
  htab *t = (htab *)mymalloc(sizeof(htab));

  len = ((ub4)1<<logsize);
  t->table = (hitem **)mymalloc(sizeof(hitem *)*(ub4)len);
